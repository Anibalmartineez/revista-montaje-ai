...
def montar_offset_desde_layout(layout_data, job_dir, preview: bool = False):
    ...
    from services.editor_offset_output_service import montar_offset_desde_layout as _montar_offset_desde_layout

    return _montar_offset_desde_layout(
        layout_data,
        job_dir,
        preview=preview,
        diseno_cls=Diseno,
        config_cls=MontajeConfig,
        render_fn=realizar_montaje_inteligente,
    )
